...
a,b,c,d,e = numpy.loadtxt("NVDA.csv", delimiter=",", unpack=True)
...
alphavantage = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=NVDA&apikey=TB81Z6OL86BE8YJN'
...
firebase.put("/NVIDIA/", "1daychange", weeklychange)
firebase.put("/NVIDIA/", "3daychange", dailychange)
firebase.put("/NVIDIA/", "estimated1day", stockday)
firebase.put("/NVIDIA/", "estimated3day", stockweek)
firebase.put("/NVIDIA/", "stockprice", closestock1)
