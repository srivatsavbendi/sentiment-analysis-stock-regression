...
a,b,c,d,e = numpy.loadtxt("DAL.csv", delimiter=",", unpack=True)
...
alphavantage = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=DAL&apikey=TB81Z6OL86BE8YJN'
...
firebase.put("/Delta/", "1daychange", weeklychange)
firebase.put("/Delta/", "3daychange", dailychange)
firebase.put("/Delta/", "estimated1day", stockday)
firebase.put("/Delta/", "estimated3day", stockweek)
firebase.put("/Delta/", "stockprice", closestock1)
