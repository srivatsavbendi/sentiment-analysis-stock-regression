...
a,b,c,d,e = numpy.loadtxt("KO.csv", delimiter=",", unpack=True)
...
alphavantage = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=KO&apikey=TB81Z6OL86BE8YJN'
...
firebase.put("/CocaCola/", "1daychange", weeklychange)
firebase.put("/CocaCola/", "3daychange", dailychange)
firebase.put("/CocaCola/", "estimated1day", stockday)
firebase.put("/CocaCola/", "estimated3day", stockweek)
firebase.put("/CocaCola/", "stockprice", closestock1)
