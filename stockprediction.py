...
a,b,c,d,e = numpy.loadtxt("GOOGL1.csv", delimiter=",", unpack=True)
...
alphavantage = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=GOOGL&apikey=TB81Z6OL86BE8YJN'
...
firebase.put("/Google/", "1daychange", weeklychange)
firebase.put("/Google/", "3daychange", dailychange)
firebase.put("/Google/", "estimated1day", stockday)
firebase.put("/Google/", "estimated3day", stockweek)
firebase.put("/Google/", "stockprice", closestock1)
