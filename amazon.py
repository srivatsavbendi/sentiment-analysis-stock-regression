...
a,b,c,d,e = numpy.loadtxt("AMZN.csv", delimiter=",", unpack=True)
...
alphavantage = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=AMZN&apikey=TB81Z6OL86BE8YJN'
...
firebase.put("/Amazon/", "1daychange", weeklychange)
firebase.put("/Amazon/", "3daychange", dailychange)
firebase.put("/Amazon/", "estimated1day", stockday)
firebase.put("/Amazon/", "estimated3day", stockweek)
firebase.put("/Amazon/", "stockprice", closestock1)
