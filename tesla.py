...
a,b,c,d,e = numpy.loadtxt("TSLA.csv", delimiter=",", unpack=True)
...
alphavantage = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=TSLA&apikey=TB81Z6OL86BE8YJN'
...
firebase.put("/Tesla/", "1daychange", weeklychange)
firebase.put("/Tesla/", "3daychange", dailychange)
firebase.put("/Tesla/", "estimated1day", stockday)
firebase.put("/Tesla/", "estimated3day", stockweek)
firebase.put("/Tesla/", "stockprice", closestock1)
