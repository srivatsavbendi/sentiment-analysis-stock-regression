...
a,b,c,d,e = numpy.loadtxt("FB.csv", delimiter=",", unpack=True)
...
alphavantage = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=FB&apikey=TB81Z6OL86BE8YJN'
...
firebase.put("/Facebook/", "1daychange", weeklychange)
firebase.put("/Facebook/", "3daychange", dailychange)
firebase.put("/Facebook/", "estimated1day", stockday)
firebase.put("/Facebook/", "estimated3day", stockweek)
firebase.put("/Facebook/", "stockprice", closestock1)
