...
a,b,c,d,e = numpy.loadtxt("NFLX.csv", delimiter=",", unpack=True)
...
alphavantage = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=NFLX&apikey=TB81Z6OL86BE8YJN'
...
firebase.put("/Netflix/", "1daychange", weeklychange)
firebase.put("/Netflix/", "3daychange", dailychange)
firebase.put("/Netflix/", "estimated1day", stockday)
firebase.put("/Netflix/", "estimated3day", stockweek)
firebase.put("/Netflix/", "stockprice", closestock1)
