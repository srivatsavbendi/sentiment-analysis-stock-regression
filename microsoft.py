...
a,b,c,d,e = numpy.loadtxt("MSFT.csv", delimiter=",", unpack=True)
...
alphavantage = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=MSFT&apikey=TB81Z6OL86BE8YJN'
...
firebase.put("/Microsoft/", "1daychange", weeklychange)
firebase.put("/Microsoft/", "3daychange", dailychange)
firebase.put("/Microsoft/", "estimated1day", stockday)
firebase.put("/Microsoft/", "estimated3day", stockweek)
firebase.put("/Microsoft/", "stockprice", closestock1)
